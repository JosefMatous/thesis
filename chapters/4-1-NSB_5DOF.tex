...
Each task produces a vector of desired velocities, $\ivel_{d,1}, \ivel_{d,2}, \ivel_{d,3} \in \mathbb{R}^{3N}$.
...
To avoid chattering, the sign functions in the low-level sliding-mode controllers \eqref{eq:nsb_5dof_t_u}--\eqref{eq:nsb_5dof_t_r} are replaced with hyperbolic tan.
