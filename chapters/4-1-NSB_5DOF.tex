...
\begin{align}        
    \begin{split}
        ...
        &\quad \scale[0.95]{ + \cos(\theta)\left(\ddot{\psi}_d - \lambda_r\,\dot{\tilde{\lambda}} - k_{\psi}\,\tilde{\psi} - k_r\,s_r - k_d\,{\rm sign}(s_r)\right), }
...
\end{equation}
thanks to the independence and orthogonality of the formation-keeping and path-following tasks.
...
\begin{proof}
    ...
    Then, we conclude that for a sufficiently large $v_i$ and $w_i$, the quadratic terms will dominate the linear terms.
...
\begin{align}
    \left\| \frac{\partial V}{\partial \tilde{\mat{X}}_1} \right\| \, \left\|\tilde{\mat{X}}_1\right\| &= \left\|\tilde{\mat{X}}_1\right\|^2 = 2\,V\!\left(\tilde{\mat{X}}_1\right),& \forall& \tilde{\mat{X}}_1, \\
    \left\| \frac{\partial V}{\partial \tilde{\mat{X}}_1} \right\| &= \left\|\tilde{\mat{X}}_1\right\| \leq \mu,& \forall& \left\|\tilde{\mat{X}}_1\right\| \leq \mu.
\end{align}
