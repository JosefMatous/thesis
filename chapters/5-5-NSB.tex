...
\begin{equation}
    \bm{\mu} = \dot{\ivel}_1 + \sum_{\dm{m}=2}^N \bar{\mathbf{N}}_{\dm{m}-1}\dot{\ivel}_{\dm{m}},
    \label{eq:NSB_double}
\end{equation}
where $\bar{\mathbf{N}}_{\dm{m}}$ is the null space projector of the augmented Jacobian \eqref{eq:background_NSB_augmented}.
