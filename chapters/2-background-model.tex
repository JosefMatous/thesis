...
Throughout the thesis, we will velocities in the body-fixed frame as $\mat{v}$, while velocities in the inertial frame will be denoted as $\ivel$.
...
\begin{figure}[b]
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \caption{Illustration of body-fixed velocities. The kinematics of the vehicle are $\dot{p} = \mat{R} \mat{v}$.}
    \end{subfigure}
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \caption{Illustration of inertial velocities. The kinematics of the vehicle are $\dot{p} = \ivel$.}
    \end{subfigure}
...
Let $\mat{v}_c = \mat{R}\T \ocean$ denote the velocity of the ocean current expressed in the vehicle's body-fixed frame.
...
Since the relative velocities are affine in the ocean current ($\mat{v}_r = \mat{v} - \mat{R}\T\ocean$), we can conclude that all terms in \eqref{eq:background_component_form_absolute_1} that contain the ocean current are also linear or quadratic. 
...
\end{subequations}
where $\mathbb{V}_c = \inlinevector{\oceanx, \oceany, \oceanz, \oceanx^2, \oceany^2, \oceanz^2, \oceanx\oceany, \oceanx\oceanz, \oceany\oceanz}$.
...
\begin{equation}
    \mat{v}_c = \mat{R}\T \ocean \quad \implies \quad
...
\begin{equation}
    \dot{\mat{v}}_c = \left(\mat{R}\mat{S}(\bs{\omega})\right)\T \ocean \triangleq \inlinevector{\dot{\mat{r}}_1, \dot{\mat{r}}_2, \dot{\mat{r}}_3} \ocean,
\end{equation}
