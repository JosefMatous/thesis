...
If the task is \emph{redundant}, \emph{i.e.}, if the inequality $n_{\dm{m}} < n$ strictly holds, then there exists a subspace of control inputs that do not interfere with the task.
