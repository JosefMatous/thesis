...
\begin{subequations}
    \begin{align}
        \mat{x}_1 &= \mat{p} + \mat{R}\dm{\handl}, \label{eq:handpos_def_hand_position} \\
        \mat{x}_2 &= \mat{R}\bvel_r + \mat{R}\left(\bs{\omega} \times \dm{\handl}\right),
    \end{align} \label{eq:handpos_def_hand_transform_initial}
\end{subequations}

\vspace*{-1.5em}

\noindent where $\dm{\handl} = \inlinevector{h, 0, 0}$, where $h > 0$ is the \emph{hand length}.
...
\begin{subequations}
    \begin{align}
        ...
        \dot{\mat{x}}_2 &= \mat{R}\Big(\inlinevector{f_u, hf_r, -hf_q}\! - \!\mathcal{D}_{\bvel}(\vel) - \mathcal{C}_{\bvel}(\vel) + \bs{\omega} \!\times\! \bvel_r + \bs{\omega} \times \left(\bs{\omega} \times \dm{\handl}\right) \label{eq:handpos_def_x_2_dot} \\
        & \qquad + \dm{\handl} \times \left(\mathcal{D}_{\bs{\omega}}(\vel) + \mathcal{C}_{\bs{\omega}}(\vel) + \mat{M}_{22}^{\prime}\left(Wz_{gb} \mat{e}_3 \times \mat{R}\T \mat{e}_3\right)\right) \Big). \nonumber
    \end{align}
\end{subequations}
...
\begin{align}
    ...
    \end{bmatrix}
    \!\!
    \bigg(\!\mat{R}\T\!\bs{\mu} + \mathcal{D}_{\bvel}(\vel) + \mathcal{C}_{\bvel}(\vel) - \bs{\omega} \times \bvel_r - \bs{\omega} \times \left(\bs{\omega} \times \dm{\handl}\right) \nonumber \\
    & \qquad \qquad - \dm{\handl} \times \Bigl(\mathcal{D}_{\bs{\omega}}(\vel) + \mathcal{C}_{\bs{\omega}}(\vel) + \mat{M}_{22}^{\prime}\!\left(Wz_{gb} \mat{e}_3 \times \mat{R}\T \mat{e}_3\right)\Bigr)\! \bigg),
\end{align}
...
\begin{subequations}
    \begin{align}
        ...
        \dot{\bs{\omega}} &= \Bar{\dm{\handl}} \times \left(\mat{R}\T\bs{\mu} + \mathcal{D}_{\bvel}(\vel) + \mathcal{C}_{\bvel}(\vel) - \bs{\omega} \times \mat{R}\T \mat{x}_2\right) \label{eq:handpos_def_omega_dot_CL} \\
...
\noindent where $\Bar{\dm{\handl}} = \inlinevector{1/h, 0, 0}$.
...
\begin{equation}
    \bvel_r = \mat{R}\T \left(\tilde{\bs{\xi}}_2 + \bs{\xi}_{2, d} - \ocean\right) - \bs{\omega} \times \dm{\handl}. \label{eq:handpos_def_nu_r_transformed}
\end{equation}
Let us define
\begin{equation}
...
\end{figure}
\dt{Note that the Lyapunov analysis in the proof is conservative and always considers the worst-case scenario.
