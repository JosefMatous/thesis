...
\begin{figure}[b]
    ...
    \caption{Illustration of (a) the traditional \dt{approach where the aim is to control the neutral point of the vehicle,} and (b) the proposed hand position-based \dt{approach}. The dashed line represents the body-fixed $x$-axis.}
